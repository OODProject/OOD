...
public class PhysicalAct extends JFrame  {
	...
	public PhysicalAct(int n) {
		
		super("Physical Action");
		num = n;
		...
		Info = new JTextField("        Patient's Physical Action");
	...
	private class theHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			...
			}else if (event.getSource() == back & num == 3) {
				dispose();
				AdminPatient p=new AdminPatient();
